...
('0AAED4DF-55D3-03DA-5860-3ABAEC00096D', '数据统计', '197', 0, 'admin/Count/active', 0, 0, '', '数据统计', 0, '', ''),
...
('102', 'SEO规则回收站', '74', 9, 'admin/Seo/ruleTrash', 0, 0, '', 'SEO规则', 0, '', ''),
('10311', '公告列表', '197', 0, 'announce/announcelist', 0, 0, '', '公告管理', 0, '', ''),
('10312', '发布公告', '197', 0, 'admin/Announce/add', 0, 0, '', '公告管理', 0, '', ''),
('10313', '应用商店', '105', 0, 'Appcloud/index', 0, 0, '', '云端', 0, 'cloud', ''),
('10314', '系统升级', '74', 99, 'admin/Update/index', 0, 0, '', '系统升级', 0, '', ''),
('10333', '系统升级流程', '10314', 0, 'Update/startupdate', 0, 0, '', '', 0, '', ''),
('10337', '消息类型列表', '197', 0, 'message/messagetypelist', 0, 0, '', '消息设置', 0, '', ''),
('10339', '消息设置', '197', 0, 'message/config', 0, 0, '', '消息设置', 0, '', ''),
...
('106', '模块安装', '105', 3, 'module/install', 1, 0, '', '本地', 0, '', ''),
('107', '模块管理', '105', 5, 'module/index', 0, 0, '', '本地', 0, '', ''),
('108', '卸载模块', '105', 7, 'module/uninstall', 1, 0, '', '本地', 0, '', ''),
('11', '删除会员', '4', 0, 'User/changeStatus?method=deleteUser', 0, 0, '"用户->用户信息"中的删除', '', 0, '', ''),
('113', '安全', '0', 5, 'ActionLimit/limitList', 0, 0, '', '', 0, 'shield', ''),
('114', '行为限制列表', '113', 6, 'admin/ActionLimit/limitList', 0, 0, '', '行为限制', 0, '', ''),
('115', '新增/编辑行为限制', '113', 7, 'admin/ActionLimit/editLimit', 1, 0, '', '行为限制', 0, '', ''),
('117', '身份列表', '2', 4, 'Role/index', 0, 0, '', '身份管理', 0, '', ''),
('12', '用户组管理', '2', 3, 'AuthManager/index', 0, 0, '', '权限管理', 0, '', ''),
...
('152', '充值积分-获取用户昵称', '53', 0, 'User/getNickname', 1, 0, '', '', 0, '', ''),
...
('164', '用户标签列表', '2', 7, 'UserTag/userTag', 0, 0, '', '身份管理', 0, '', ''),
...
('171', '网站信息', '74', 2, 'Config/website', 0, 0, '', '系统设置', 0, '', ''),
...
('231', '用户导航', '74', 4, 'admin/Channel/user', 0, 0, '', '导航管理', 0, '', ''),
('232', '积分日志', '113', 0, 'Action/scoreLog', 0, 0, '', '积分管理', 0, '', ''),
...
('4', '行为&积分规则', '113', 3, 'Action/action', 0, 0, '', '行为管理', 0, '', ''),
...
('53', '充值积分', '113', 5, 'User/recharge', 1, 0, '', '积分管理', 0, '用户管理', ''),
...
('75', '网站设置', '74', 1, 'Config/group', 0, 0, '', '系统设置', 0, '', ''),
('76', '配置管理', '74', 7, 'admin/Config/index', 0, 0, '', '系统设置', 0, '', ''),
...
('82', '后台导航', '74', 6, 'admin/Menu/index', 0, 0, '', '导航管理', 0, '', ''),
('83', '新增', '82', 0, 'Menu/add', 0, 0, '', '系统设置', 0, '', ''),
('84', '编辑', '82', 0, 'Menu/edit', 0, 0, '', '', 0, '', ''),
('85', '导入', '82', 0, 'Menu/import', 0, 0, '', '', 0, '', ''),
('86', '排序', '82', 0, 'Menu/sort', 1, 0, '', '', 0, '', ''),
('87', '前台导航', '74', 5, 'admin/Channel/index', 0, 0, '', '导航管理', 0, '', ''),
('88', '新增', '87', 0, 'Channel/add', 0, 0, '', '', 0, '', ''),
('89', '编辑', '87', 0, 'Channel/edit', 0, 0, '', '', 0, '', ''),
('8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', '计划任务', '74', 98, 'admin/Schedule/schedulelist', 0, 0, '', '计划任务', 0, '', ''),
