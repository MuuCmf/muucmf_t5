...
str;
        ...
        $admin_config
            ...
            ->keyRadio('NICKNAME_SWITCH', lang('_NICKNAME_SWITCH_'), lang('_NICKNAME_SWITCH_DESCRIPTION_'), array(0 => lang('_OFF_'), 1 => lang('_OPEN_')))
            ...
            ->keyText('REG_USER_URL','注册完成后跳转页面','自定义用户注册成功后跳转至页面，格式：模块/控制器/方法')
            ...
            //分组
            ->group(lang('_REGISTER_CONFIGURATION_'), 'REG_SWITCH,EMAIL_VERIFY_TYPE,MOBILE_VERIFY_TYPE,NICKNAME_SWITCH,REG_STEP,REG_CAN_SKIP,NEW_USER_FOLLOW,NEW_USER_FANS,NEW_USER_FRIENDS,REG_USER_URL,REG_USER_TEMPLATE')
