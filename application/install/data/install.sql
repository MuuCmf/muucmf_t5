...
('10311', '公告列表', '197', 0, 'announce/announcelist', 0, 0, '', '公告管理', 0, 'bullhorn', ''),
...
('10451', '设置公告状态', '10311', 0, 'Announce/setStatus', 0, 0, '', '公告管理', 0, '', ''),
('10452', '公告送达情况', '10311', 0, 'Announce/arrive', 0, 0, '', '公告管理', 0, '', ''),
('10453', '公告编辑', '10311', 0, 'announce/edit', 0, 0, '', '公告管理', 0, '', ''),
('10458', '扩展设置', '74', 3, 'Config/expandConfig', 0, 0, '', '系统设置', 0, 'cogs', ''),
...
('108', '卸载模块', '107', 7, 'module/uninstall', 1, 0, '', '本地', 0, '', ''),
('113', '安全', '0', 5, 'ActionLimit/limitList', 0, 0, '', '', 0, 'shield', ''),
('114', '行为限制列表', '113', 6, 'admin/ActionLimit/limitList', 0, 0, '', '行为管理', 0, 'ban', ''),
('115', '新增/编辑行为限制', '114', 7, 'admin/ActionLimit/editLimit', 0, 0, '', '', 0, '', ''),
('117', '身份列表', '2', 4, 'Role/index', 0, 0, '', '身份管理', 0, 'vcard', ''),
('12', '用户组管理', '2', 3, 'AuthManager/index', 0, 0, '', '权限管理', 0, 'users', ''),
...
('126', '身份分组', '2', 5, 'Role/group', 0, 0, '', '身份管理', 0, 'group', ''),
('127', '编辑分组', '126', 0, 'Role/editGroup', 1, 0, '', '', 0, '', ''),
('128', '删除分组', '126', 0, 'Role/deleteGroup', 1, 0, '', '', 0, '', ''),
('13', '删除', '12', 0, 'AuthManager/changeStatus?method=deleteGroup', 0, 0, '删除用户组', '', 0, '', ''),
('134', '上传默认头像', '123', 0, 'Role/uploadPicture', 1, 0, '', '', 0, '', ''),
('14', '禁用', '12', 0, 'AuthManager/changeStatus?method=forbidGroup', 0, 0, '禁用用户组', '', 0, '', ''),
('148', '删除日志', '31', 0, 'Action/remove', 1, 0, '', '', 0, '', ''),
('149', '清空日志', '31', 0, 'Action/clear', 1, 0, '', '', 0, '', ''),
('15', '恢复', '12', 0, 'AuthManager/changeStatus?method=resumeGroup', 0, 0, '恢复已禁用的用户组', '', 0, '', ''),
('150', '设置积分状态', '51', 0, 'User/setTypeStatus', 1, 0, '', '', 0, '', ''),
('151', '删除积分类型', '51', 0, 'User/delType', 1, 0, '', '', 0, '', ''),
('153', '删除菜单', '82', 0, 'Menu/del', 1, 0, '', '', 0, '', ''),
('154', '设置开发者模式可见', '82', 0, 'Menu/toogleDev', 1, 0, '', '', 0, '', ''),
('155', '设置显示隐藏', '82', 0, 'Menu/toogleHide', 1, 0, '', '', 0, '', ''),
('156', '行为限制启用、禁用、删除', '114', 0, 'ActionLimit/setLimitStatus', 1, 0, '', '', 0, '', ''),
('157', '启用、禁用、删除、回收站还原', '99', 0, 'SEO/setRuleStatus', 1, 0, '', '', 0, '', ''),
('158', '回收站彻底删除', '102', 0, 'SEO/doClear', 1, 0, '', '', 0, '', ''),
('16', '新增', '12', 0, 'AuthManager/createGroup', 0, 0, '创建新的用户组', '', 0, '', ''),
('160', '删除钩子', '58', 0, 'Addons/delHook', 0, 0, '', '', 0, '', ''),
('164', '用户标签列表', '2', 7, 'UserTag/userTag', 0, 0, '', '身份管理', 0, 'tags', ''),
('165', '添加分类、标签', '164', 0, 'UserTag/add', 1, 0, '', '', 0, '', ''),
('166', '设置分类、标签状态', '164', 0, 'UserTag/setStatus', 1, 0, '', '', 0, '', ''),
('167', '分类、标签回收站', '164', 0, 'UserTag/tagTrash', 1, 0, '', '', 0, '', ''),
('168', '测底删除回收站内容', '164', 0, 'UserTag/userTagClear', 1, 0, '', '', 0, '', ''),
('17', '编辑', '12', 0, 'AuthManager/editGroup', 0, 0, '编辑用户组名称和描述', '', 0, '', ''),
('170', '编辑模块', '107', 0, 'Module/edit', 1, 0, '', '模块管理', 0, '', ''),
('171', '网站信息', '74', 2, 'Config/website', 0, 0, '', '系统设置', 0, 'th-list', ''),
('18', '保存用户组', '12', 0, 'AuthManager/writeGroup', 0, 0, '新增和编辑用户组的"保存"按钮', '', 0, '', ''),
('19', '授权', '12', 0, 'AuthManager/group', 0, 0, '"后台 \\ 用户 \\ 用户信息"列表页的"授权"操作按钮,用于设置用户所属用户组', '', 0, '', ''),
('197', '运营', '0', 4, 'announce/announcelist', 0, 0, '', '', 0, 'laptop', ''),
...
('227', '新增广告', '226', 0, 'Adv/editAdv', 1, 0, '', '', 0, '', ''),
('228', '编辑广告位', '225', 0, 'Adv/editPos', 1, 0, '', '', 0, '', ''),
('229', '设置广告位状态', '225', 0, 'Adv/setPosStatus', 1, 0, '', '', 0, '', ''),
('23', '保存成员授权', '12', 0, 'AuthManager/addToGroup', 0, 0, '"用户信息"列表页"授权"时的"保存"按钮和"成员授权"里右上角的"添加"按钮)', '', 0, '', ''),
('230', '广告排期', '226', 0, 'Adv/schedule', 1, 0, '', '', 0, '', ''),
('231', '用户导航', '74', 4, 'admin/Channel/user', 0, 0, '', '导航管理', 0, 'user-plus', ''),
('232', '积分日志', '113', 0, 'admin/Action/scoreLog', 0, 0, '', '积分管理', 0, 'calendar', ''),
('24', '分类授权', '12', 0, 'AuthManager/category', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"分类授权"操作按钮', '', 0, '', ''),
('25', '保存分类授权', '12', 0, 'AuthManager/addToCategory', 0, 0, '"分类授权"页面的"保存"按钮', '', 0, '', ''),
('26', '模型授权', '12', 0, 'AuthManager/modelauth', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"模型授权"操作按钮', '', 0, '', ''),
('27', '保存模型授权', '12', 0, 'AuthManager/addToModel', 0, 0, '"分类授权"页面的"保存"按钮', '', 0, '', ''),
('28', '新增权限节点', '12', 0, 'AuthManager/addNode', 1, 0, '', '', 1, '', ''),
('29', '前台权限管理', '12', 0, 'AuthManager/accessUser', 1, 0, '', '权限管理', 0, '', ''),
('294859E5-C33E-098A-EDEB-B88928EF4DEC', '编辑', '3', 0, 'admin/User/expandinfo_details', 0, 0, '', '', 0, '', ''),
('3', '用户信息', '2', 2, 'User/index', 0, 0, '', '用户管理', 0, 'user', ''),
('30', '删除权限节点', '12', 0, 'AuthManager/deleteNode', 1, 0, '', '', 0, '', ''),
('31', '行为日志', '113', 4, 'admin/Action/actionlog', 0, 0, '', '行为管理', 0, 'list-ul', ''),
('32', '查看行为日志', '31', 0, 'action/detail', 1, 0, '', '', 0, '', ''),
('321A7323-8C14-D79D-9AE6-5F57F1CAB212', '查看日志', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/Schedule/showLog', 0, 0, '', '', 0, '', ''),
('39', '扩展资料', '2', 6, 'User/profile', 0, 0, '', '身份管理', 0, 'expand', ''),
...
('50', '用户注册配置', '2', 1, 'UserConfig/index', 0, 0, '', '注册配置', 0, 'user-circle', ''),
...
('60', '检测创建', '57', 0, 'Addons/checkForm', 0, 0, '检测插件是否可以创建', '', 0, '', ''),
('61', '预览', '57', 0, 'Addons/preview', 0, 0, '预览插件定义类文件', '', 0, '', ''),
...
('62', '快速生成插件', '57', 0, 'Addons/build', 0, 0, '开始生成插件结构', '', 0, '', ''),
('64', '设置', '57', 0, 'Addons/config', 0, 0, '设置插件配置', '', 0, '', ''),
('65', '禁用', '57', 0, 'Addons/disable', 0, 0, '禁用插件', '', 0, '', ''),
('66', '启用', '57', 0, 'Addons/enable', 0, 0, '启用插件', '', 0, '', ''),
('67', '安装', '57', 0, 'Addons/install', 0, 0, '安装插件', '', 0, '', ''),
('68', '卸载', '57', 0, 'Addons/uninstall', 0, 0, '卸载插件', '', 0, '', ''),
('69', '更新配置', '57', 0, 'Addons/saveconfig', 0, 0, '更新插件配置处理', '', 0, '', ''),
...
('70', '插件后台列表', '57', 0, 'Addons/adminList', 0, 0, '', '', 0, '', ''),
('71', 'URL方式访问插件', '57', 0, 'Addons/execute', 0, 0, '控制是否有权限通过url访问插件控制器方法', '', 0, '', ''),
('72', '新增钩子', '58', 0, 'Addons/addHook', 0, 0, '', '', 0, '', ''),
('73', '编辑钩子', '58', 0, 'Addons/edithook', 0, 0, '', '', 0, '', ''),
('74', '系统', '0', 6, 'admin/Config/group', 0, 0, '', '', 0, 'windows', ''),
('75', '网站设置', '74', 1, 'Config/group', 0, 0, '', '系统设置', 0, 'cog', ''),
('76', '配置管理', '74', 7, 'admin/Config/index', 0, 0, '', '系统设置', 0, 'list-ul', ''),
('77', '编辑', '76', 0, 'Config/edit', 0, 0, '新增编辑和保存配置', '', 0, '', ''),
('78', '删除', '76', 0, 'Config/del', 0, 0, '删除配置', '', 0, '', ''),
('79', '新增', '76', 0, 'Config/add', 0, 0, '新增配置', '', 0, '', ''),
('8', '变更行为状态', '4', 0, 'admin/action/setStatus', 0, 0, '', '', 0, '', ''),
('80', '保存', '76', 0, 'Config/save', 0, 0, '保存配置', '', 0, '', ''),
('81', '排序', '76', 0, 'Config/sort', 1, 0, '', '', 0, '', ''),
('82', '后台导航', '74', 6, 'admin/Menu/index', 0, 0, '', '导航管理', 0, 'navicon', ''),
('83', '新增', '82', 0, 'Menu/add', 0, 0, '', '系统设置', 0, '', ''),
('84', '编辑', '82', 0, 'Menu/edit', 0, 0, '', '', 0, '', ''),
('85', '导入', '82', 0, 'Menu/import', 0, 0, '', '', 0, '', ''),
('86', '排序', '82', 0, 'Menu/sort', 1, 0, '', '', 0, '', ''),
('87', '前台导航', '74', 5, 'admin/Channel/index', 0, 0, '', '导航管理', 0, 'sitemap', ''),
('88', '新增', '87', 0, 'Channel/add', 0, 0, '', '', 0, '', ''),
('89', '编辑', '87', 0, 'Channel/edit', 0, 0, '', '', 0, '', ''),
('8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', '计划任务', '74', 98, 'admin/Schedule/schedulelist', 0, 0, '', '计划任务', 0, 'tasks', ''),
('90', '删除', '87', 0, 'Channel/del', 0, 0, '', '', 0, '', ''),
('90DB7582-14E5-94E6-E3D7-0D44B6FAA5D3', '留存率统计', '0AAED4DF-55D3-03DA-5860-3ABAEC00096D', 0, 'admin/count/remain', 0, 0, '', '', 0, '', ''),
('91', '排序', '87', 0, 'Channel/sort', 1, 0, '', '', 0, '', ''),
('92', '备份数据库', '113', 8, 'admin/Database/dataExport', 0, 0, '', '数据备份', 0, 'database', ''),
('93', '备份', '92', 0, 'Database/export', 0, 0, '备份数据库', '', 0, '', ''),
('94', '优化表', '92', 0, 'Database/optimize', 0, 0, '优化数据表', '', 0, '', ''),
('95', '修复表', '92', 0, 'Database/repair', 0, 0, '修复数据表', '', 0, '', ''),
('96', '还原数据库', '113', 9, 'admin/Database/dataImport', 0, 0, '', '数据备份', 0, 'window-restore', ''),
('97', '恢复', '96', 0, 'Database/import', 0, 0, '数据库恢复', '', 0, '', ''),
('98', '删除', '96', 0, 'Database/del', 0, 0, '删除备份文件', '', 0, '', ''),
