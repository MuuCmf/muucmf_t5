    ...
    public function uninstall()
    {
        ...
        if (request()->isPost()) {
            ...
            if ($res == true) {
                ...
                $this->success(lang('_THE_SUCCESS_OF_THE_UNLOADING_MODULE_'), U('lists'));
            } else {
                $this->error(lang('_FAILURE_OF_THE_UNLOADING_MODULE_') . $this->moduleModel->error);
            }
        ...
        $builder->keyBool('withoutData', lang('_KEEP_DATA_MODULE_').'?', lang('_DEFAULT_RESERVATION_MODULE_DATA_'))->keyBool('remove_nav', lang('_REMOVE_NAVIGATION_'), lang('_UNINSTALL_AUTO_UNINSTALL_MENU_',array('link'=>U('channel/index'))));
    ...
    public function install()
    {
        ...
        if (request()->isPost()) {
            ...
            if ($res === true) {
                ...
                $this->success(lang('_INSTALLATION_MODULE_SUCCESS_'), U('lists'));
            } else {
