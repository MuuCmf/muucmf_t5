...
(134, 'URL_MODEL', 4, 'URL模式', 4, '2:REWRITE模式(开启伪静态)\r\n3:兼容模式', '选择Rewrite模式则开启伪静态，在开启伪静态之前需要先设置伪静态或阅读/Rewrite/readme.txt中的说明，默认建议开启兼容模式', 1421027546, 1421027676, 1, '3', 0),
(135, 'DEFUALT_HOME_URL', 1, '登录前首页Url', 1, '', '支持Home/index/index的ThinkPhp路由写法，支持普通的url写法，留空默认聚合首页', 1417509438, 1427340006, 1, '', 1),
...
(1005, '_CONFIG_ABOUT_US', 0, '', 0, '', '', 1572512453, 1572512453, 1, '<style>.common-aboutus .aboutus{margin:10px auto;width:100px}.common-aboutus .aboutus ul{list-style:none}.common-aboutus .aboutus ul li{padding:10px;list-style:none}</style><div class="row"><div class="col-xs-6"><img src="http://www.muucmf.cn/static/common/images/logo.png" class="logo" alt="MuuCmf开源PHP后端开发框架"><p>MuuCmf是一个将CMS和Framework两个概念完美结合的内容管理系统，提供了丰富的系统功能。开发人员只需要专注于业务系统的开发，或通过MuuCmf应用商店下载你需要的模块实现更快部署...。</p><p>QQ开发交流群</p><h3>633857075</h3><p>技术支持邮箱</p><h3>support@hoomuu.cn</h3></div><div class="col-xs-6"><div class="aboutus text-center"><h2>关于我们</h2><ul class="list-padding"><li><a>MuuCmf简介</a></li><li><a>招兵买马</a></li><li><a>BLOG</a></li><li><a>媒体报道</a></li><li><a>服务条款</a></li></ul></div></div></div>', 0),
(1006, '_CONFIG_SUBSCRIB_US', 0, '', 0, '', '', 1572512453, 1572512453, 1, '<div class="text-center"><h2>关注公众号</h2></div>\r\n<div class="text-center" style="width:150px;margin:10px auto;">\r\n<img src="http://www.muucmf.cn/static/common/images/qrcode.png" class="img-responsive">\r\n</div>', 0),
...
('100', '新增、编辑', '99', 0, 'admin/SEO/editRule', 0, 0, '', '', 0, '', ''),
('10001', '基本设置', '10000', 0, 'index/Admin/config', 0, 0, '', '设置', 0, '', 'index'),
('101', '排序', '99', 0, 'admin/SEO/sortRule', 1, 0, '', '', 0, '', ''),
('102', 'SEO规则回收站', '74', 9, 'admin/Seo/ruleTrash', 0, 0, '', 'SEO规则', 0, 'trash', ''),
('10311', '公告列表', '197', 0, 'admin/announce/announcelist', 0, 0, '', '公告管理', 0, 'bullhorn', ''),
('10312', '发布公告', '197', 0, 'admin/Announce/add', 0, 0, '', '公告管理', 0, 'edit', ''),
('10313', '应用商店', '105', 0, 'admin/Appcloud/index', 0, 0, '', '云端', 0, 'cloud', ''),
('10314', '系统升级', '74', 99, 'admin/Update/index', 0, 0, '', '系统升级', 0, 'cloud-download', ''),
('10333', '系统升级流程', '10314', 0, 'Update/startupdate', 0, 0, '', '', 0, '', ''),
('10337', '消息类型列表', '197', 0, 'admin/Message/messagetypelist', 0, 0, '', '消息设置', 0, 'commenting', ''),
('10339', '消息设置', '197', 0, 'admin/Message/config', 0, 0, '', '消息设置', 0, 'commenting', ''),
('10451', '设置公告状态', '10311', 0, 'admin/Announce/setStatus', 0, 0, '', '公告管理', 0, '', ''),
('10452', '公告送达情况', '10311', 0, 'admin/Announce/arrive', 0, 0, '', '公告管理', 0, '', ''),
('10453', '公告编辑', '10311', 0, 'admin/announce/edit', 0, 0, '', '公告管理', 0, '', ''),
('10458', '扩展设置', '74', 3, 'admin/Config/expandConfig', 0, 0, '', '系统设置', 0, 'cogs', ''),
('105', '应用', '0', 7, 'admin/Module/index', 0, 0, '', '', 0, 'cloud', ''),
('106', '模块安装', '107', 3, 'module/install', 0, 0, '', '本地', 0, '', ''),
('107', '模块管理', '105', 5, 'admin/Module/index', 0, 0, '', '本地', 0, 'laptop', ''),
('108', '卸载模块', '107', 7, 'admin/module/uninstall', 1, 0, '', '本地', 0, '', ''),
('113', '安全', '0', 5, 'admin/ActionLimit/limitList', 0, 0, '', '', 0, 'shield', ''),
('114', '行为限制列表', '113', 6, 'admin/ActionLimit/limitList', 0, 0, '', '行为管理', 0, 'ban', ''),
('115', '新增/编辑行为限制', '114', 7, 'admin/ActionLimit/editLimit', 0, 0, '', '', 0, '', ''),
('117', '身份列表', '2', 4, 'admin/Role/index', 0, 0, '', '身份管理', 0, 'vcard', ''),
('12', '用户组管理', '2', 3, 'admin/AuthManager/index', 0, 0, '', '权限管理', 0, 'users', ''),
('121', '默认积分配置', '117', 0, 'admin/Role/configScore', 1, 0, '', '', 0, '', ''),
('122', '默认权限配置', '117', 0, 'admin/Role/configAuth', 1, 0, '', '', 0, '', ''),
('123', '默认头像配置', '117', 0, 'admin/Role/configAvatar', 1, 0, '', '', 0, '', ''),
('125', '默认字段管理', '117', 0, 'admin/Role/configField', 1, 0, '', '', 0, '', ''),
('126', '身份分组', '2', 5, 'admin/Role/group', 0, 0, '', '身份管理', 0, 'group', ''),
('127', '编辑分组', '126', 0, 'admin/Role/editGroup', 1, 0, '', '', 0, '', ''),
('128', '删除分组', '126', 0, 'admin/Role/deleteGroup', 1, 0, '', '', 0, '', ''),
('13', '删除', '12', 0, 'admin/AuthManager/changeStatus?method=deleteGroup', 0, 0, '删除用户组', '', 0, '', ''),
('134', '上传默认头像', '123', 0, 'admin/Role/uploadPicture', 1, 0, '', '', 0, '', ''),
('14', '禁用', '12', 0, 'admin/AuthManager/changeStatus?method=forbidGroup', 0, 0, '禁用用户组', '', 0, '', ''),
('148', '删除日志', '31', 0, 'admin/Action/remove', 1, 0, '', '', 0, '', ''),
('149', '清空日志', '31', 0, 'admin/Action/clear', 1, 0, '', '', 0, '', ''),
('15', '恢复', '12', 0, 'admin/AuthManager/changeStatus?method=resumeGroup', 0, 0, '恢复已禁用的用户组', '', 0, '', ''),
('150', '设置积分状态', '51', 0, 'admin/User/setTypeStatus', 1, 0, '', '', 0, '', ''),
('151', '删除积分类型', '51', 0, 'admin/User/delType', 1, 0, '', '', 0, '', ''),
('153', '删除菜单', '82', 0, 'admin/Menu/del', 1, 0, '', '', 0, '', ''),
('154', '设置开发者模式可见', '82', 0, 'admin/Menu/toogleDev', 1, 0, '', '', 0, '', ''),
('155', '设置显示隐藏', '82', 0, 'admin/Menu/toogleHide', 1, 0, '', '', 0, '', ''),
('156', '行为限制启用、禁用、删除', '114', 0, 'admin/ActionLimit/setLimitStatus', 1, 0, '', '', 0, '', ''),
('157', '启用、禁用、删除、回收站还原', '99', 0, 'admin/SEO/setRuleStatus', 1, 0, '', '', 0, '', ''),
('158', '回收站彻底删除', '102', 0, 'admin/SEO/doClear', 1, 0, '', '', 0, '', ''),
('16', '新增', '12', 0, 'AuthManager/createGroup', 0, 0, '创建新的用户组', '', 0, '', ''),
('160', '删除钩子', '58', 0, 'admin/Addons/delHook', 0, 0, '', '', 0, '', ''),
('164', '用户标签列表', '2', 7, 'admin/UserTag/userTag', 0, 0, '', '身份管理', 0, 'tags', ''),
('165', '添加分类、标签', '164', 0, 'admin/UserTag/add', 1, 0, '', '', 0, '', ''),
('166', '设置分类、标签状态', '164', 0, 'admin/UserTag/setStatus', 1, 0, '', '', 0, '', ''),
('167', '分类、标签回收站', '164', 0, 'admin/UserTag/tagTrash', 1, 0, '', '', 0, '', ''),
('168', '测底删除回收站内容', '164', 0, 'admin/UserTag/userTagClear', 1, 0, '', '', 0, '', ''),
('17', '编辑', '12', 0, 'AuthManager/editGroup', 0, 0, '编辑用户组名称和描述', '', 0, '', ''),
('170', '编辑模块', '107', 0, 'admin/Module/edit', 1, 0, '', '模块管理', 0, '', ''),
('171', '网站信息', '74', 2, 'admin/Config/website', 0, 0, '', '系统设置', 0, 'th-list', ''),
('18', '保存用户组', '12', 0, 'admin/AuthManager/writeGroup', 0, 0, '新增和编辑用户组的"保存"按钮', '', 0, '', ''),
('19', '授权', '12', 0, 'admin/AuthManager/group', 0, 0, '"后台 \\ 用户 \\ 用户信息"列表页的"授权"操作按钮,用于设置用户所属用户组', '', 0, '', ''),
('197', '运营', '0', 4, 'admin/Announce/announcelist', 0, 0, '', '', 0, 'laptop', ''),
('198', '群发消息用户列表', '197', 4, 'admin/Message/userList', 0, 0, '', '群发消息', 0, 'commenting', ''),
('1E82B5BE-3CCF-C30D-F604-728174A3281F', '文章', '0', 0, 'articles/admin/index', 0, 1, '', '', 0, '', 'articles'),
('2', '用户', '0', 3, 'admin/User/index', 0, 0, '', '', 0, 'user', ''),
('20', '访问授权', '12', 0, 'AuthManager/access', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"访问授权"操作按钮', '', 0, '', ''),
('201', '重置用户密码', '3', 0, 'admin/User/initpass', 1, 0, '', '', 0, '', ''),
('21', '成员授权', '12', 0, 'AuthManager/user', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"成员授权"操作按钮', '', 0, '', ''),
('22', '解除授权', '12', 0, 'AuthManager/removeFromGroup', 0, 0, '"成员授权"列表页内的解除授权操作按钮', '', 0, '', ''),
('225', '广告位', '197', 0, 'admin/Adv/pos', 0, 0, '', '广告配置', 0, 'photo', ''),
('226', '广告管理', '225', 0, 'admin/Adv/adv', 0, 0, '', '', 0, '', ''),
('227', '新增广告', '226', 0, 'admin/Adv/editAdv', 1, 0, '', '', 0, '', ''),
('228', '编辑广告位', '225', 0, 'admin/Adv/editPos', 1, 0, '', '', 0, '', ''),
('229', '设置广告位状态', '225', 0, 'Adv/setPosStatus', 1, 0, '', '', 0, '', ''),
('23', '保存成员授权', '12', 0, 'admin/AuthManager/addToGroup', 0, 0, '"用户信息"列表页"授权"时的"保存"按钮和"成员授权"里右上角的"添加"按钮)', '', 0, '', ''),
('230', '广告排期', '226', 0, 'admin/Adv/schedule', 1, 0, '', '', 0, '', ''),
('231', '用户导航', '74', 4, 'admin/Channel/user', 0, 0, '', '导航管理', 0, 'user-plus', ''),
('232', '积分日志', '113', 0, 'admin/Action/scoreLog', 0, 0, '', '积分管理', 0, 'calendar', ''),
('24', '分类授权', '12', 0, 'admin/AuthManager/category', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"分类授权"操作按钮', '', 0, '', ''),
('25', '保存分类授权', '12', 0, 'admin/AuthManager/addToCategory', 0, 0, '"分类授权"页面的"保存"按钮', '', 0, '', ''),
('26', '模型授权', '12', 0, 'admin/AuthManager/modelauth', 0, 0, '"后台 \\ 用户 \\ 权限管理"列表页的"模型授权"操作按钮', '', 0, '', ''),
('27', '保存模型授权', '12', 0, 'admin/AuthManager/addToModel', 0, 0, '"分类授权"页面的"保存"按钮', '', 0, '', ''),
('28', '新增权限节点', '12', 0, 'admin/AuthManager/addNode', 1, 0, '', '', 1, '', ''),
('29', '前台权限管理', '12', 0, 'admin/AuthManager/accessUser', 1, 0, '', '权限管理', 0, '', ''),
('294859E5-C33E-098A-EDEB-B88928EF4DEC', '编辑', '3', 0, 'admin/User/expandinfo_details', 0, 0, '', '', 0, '', ''),
('3', '用户信息', '2', 2, 'admin/User/index', 0, 0, '', '用户管理', 0, 'user', ''),
('30', '删除权限节点', '12', 0, 'admin/AuthManager/deleteNode', 1, 0, '', '', 0, '', ''),
('31', '行为日志', '113', 4, 'admin/Action/actionlog', 0, 0, '', '行为管理', 0, 'list-ul', ''),
('32', '查看行为日志', '31', 0, 'admin/action/detail', 1, 0, '', '', 0, '', ''),
('321A7323-8C14-D79D-9AE6-5F57F1CAB212', '查看日志', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/Schedule/showLog', 0, 0, '', '', 0, '', ''),
('39', '扩展资料', '2', 6, 'admin/User/profile', 0, 0, '', '身份管理', 0, 'expand', ''),
('3DB48266-6033-AA7D-3127-2E9F8618D05E', '清空日志', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/schedule/clearLog', 0, 0, '', '', 0, '', ''),
('3DF9AF85-D26A-41B3-7A63-113BC988F3B8', '打包向导', '5C8C82C4-A290-A74C-058A-59A176BEEDCB', 0, 'devtool/Admin/module', 0, 1, '', '模块管理', 0, '', 'devtool'),
('4', '行为&积分规则', '113', 3, 'admin/Action/action', 0, 0, '', '行为管理', 0, 'hand-pointer-o', ''),
...
('4E17F76C-C15E-B0A8-64FD-D5284FDC1CE4', '编辑、新增计划任务', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/schedule/editschedule', 0, 0, '', '', 0, '', ''),
...
('4EF3A41F-05CE-A63A-56DF-97304225216E', '重启计划任务', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/Schedule/reRun', 0, 0, '', '', 0, '', ''),
('4F2D321E-E4A3-B7BD-281A-8AC459B22B35', '流失率统计', '0AAED4DF-55D3-03DA-5860-3ABAEC00096D', 0, 'admin/count/lost', 0, 0, '', '', 0, '', ''),
('50', '用户注册配置', '2', 1, 'admin/UserConfig/index', 0, 0, '', '注册配置', 0, 'user-circle', ''),
('51', '积分类型列表', '113', 1, 'admin/User/scoreList', 0, 0, '', '积分管理', 0, 'sticky-note', ''),
('52', '新增/编辑类型', '51', 2, 'admin/User/editScoreType', 1, 0, '', '', 0, '', ''),
('57', '插件管理', '105', 4, 'admin/Addons/index', 0, 0, '', '本地', 0, 'plus-square', ''),
('58', '钩子管理', '105', 2, 'admin/Addons/hooks', 1, 0, '', '本地', 0, '', ''),
('59', '创建', '57', 0, 'admin/Addons/create', 0, 0, '服务器上创建插件结构向导', '', 0, '', ''),
...
('60', '检测创建', '57', 0, 'admin/Addons/checkForm', 0, 0, '检测插件是否可以创建', '', 0, '', ''),
('61', '预览', '57', 0, 'admin/Addons/preview', 0, 0, '预览插件定义类文件', '', 0, '', ''),
...
('62', '快速生成插件', '57', 0, 'admin/Addons/build', 0, 0, '开始生成插件结构', '', 0, '', ''),
('64', '设置', '57', 0, 'admin/Addons/config', 0, 0, '设置插件配置', '', 0, '', ''),
('65', '禁用', '57', 0, 'admin/Addons/disable', 0, 0, '禁用插件', '', 0, '', ''),
('66', '启用', '57', 0, 'admin/Addons/enable', 0, 0, '启用插件', '', 0, '', ''),
('67', '安装', '57', 0, 'admin/Addons/install', 0, 0, '安装插件', '', 0, '', ''),
('68', '卸载', '57', 0, 'admin/Addons/uninstall', 0, 0, '卸载插件', '', 0, '', ''),
('69', '更新配置', '57', 0, 'admin/Addons/saveconfig', 0, 0, '更新插件配置处理', '', 0, '', ''),
('69735C59-69D8-0040-0905-3C48453C644A', '设置计划任务状态', '8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', 0, 'admin/Schedule/setScheduleStatus', 0, 0, '', '', 0, '', ''),
('70', '插件后台列表', '57', 0, 'admin/Addons/adminList', 0, 0, '', '', 0, '', ''),
('71', 'URL方式访问插件', '57', 0, 'admin/Addons/execute', 0, 0, '控制是否有权限通过url访问插件控制器方法', '', 0, '', ''),
('72', '新增钩子', '58', 0, 'admin/Addons/addHook', 0, 0, '', '', 0, '', ''),
('73', '编辑钩子', '58', 0, 'admin/Addons/edithook', 0, 0, '', '', 0, '', ''),
('74', '系统', '0', 6, 'admin/Config/group', 0, 0, '', '', 0, 'windows', ''),
('75', '网站设置', '74', 1, 'admin/Config/group', 0, 0, '', '系统设置', 0, 'cog', ''),
('76', '配置管理', '74', 7, 'admin/Config/index', 0, 0, '', '系统设置', 0, 'list-ul', ''),
('77', '编辑', '76', 0, 'admin/Config/edit', 0, 0, '新增编辑和保存配置', '', 0, '', ''),
('78', '删除', '76', 0, 'admin/Config/del', 0, 0, '删除配置', '', 0, '', ''),
('79', '新增', '76', 0, 'admin/Config/add', 0, 0, '新增配置', '', 0, '', ''),
('8', '变更行为状态', '4', 0, 'admin/action/setStatus', 0, 0, '', '', 0, '', ''),
('80', '保存', '76', 0, 'admin/Config/save', 0, 0, '保存配置', '', 0, '', ''),
('81', '排序', '76', 0, 'admin/Config/sort', 1, 0, '', '', 0, '', ''),
('82', '后台导航', '74', 6, 'admin/Menu/index', 0, 0, '', '导航管理', 0, 'navicon', ''),
...
('87', '前台导航', '74', 5, 'admin/Channel/index', 0, 0, '', '导航管理', 0, 'sitemap', ''),
('88', '新增', '87', 0, 'admin/Channel/add', 0, 0, '', '', 0, '', ''),
('89', '编辑', '87', 0, 'admin/Channel/edit', 0, 0, '', '', 0, '', ''),
('8C87F66E-4A84-7A4F-0B80-BA6A4A4C87C7', '计划任务', '74', 98, 'admin/Schedule/schedulelist', 0, 0, '', '计划任务', 0, 'tasks', ''),
('90', '删除', '87', 0, 'admin/Channel/del', 0, 0, '', '', 0, '', ''),
('90DB7582-14E5-94E6-E3D7-0D44B6FAA5D3', '留存率统计', '0AAED4DF-55D3-03DA-5860-3ABAEC00096D', 0, 'admin/count/remain', 0, 0, '', '', 0, '', ''),
('91', '排序', '87', 0, 'admin/Channel/sort', 1, 0, '', '', 0, '', ''),
('92', '备份数据库', '113', 8, 'admin/Database/dataExport', 0, 0, '', '数据备份', 0, 'database', ''),
...
('96', '还原数据库', '113', 9, 'admin/Database/dataImport', 0, 0, '', '数据备份', 0, 'window-restore', ''),
('97', '恢复', '96', 0, 'admin/Database/import', 0, 0, '数据库恢复', '', 0, '', ''),
('98', '删除', '96', 0, 'admin/Database/del', 0, 0, '删除备份文件', '', 0, '', ''),
('99', 'SEO规则管理', '74', 8, 'admin/Seo/index', 0, 0, '', 'SEO规则', 0, 'television', ''),
...
('C4CC7169-B231-F900-5583-13F1156E0FF2', '编辑', '117', 0, 'admin/role/editrole', 0, 0, '', '', 0, '', ''),
...
('F113A688-808F-A22A-61BD-F68D024BBC1F', '活跃用户统计', '0AAED4DF-55D3-03DA-5860-3ABAEC00096D', 0, 'admin/count/active', 0, 0, '', '', 0, '', ''),
('F20F49CB-0FCB-67E1-6927-D5C8386118C2', '默认标签配置', '117', 0, 'admin/role/configusertag', 0, 0, '', '', 0, '', ''),
...
CREATE TABLE IF NOT EXISTS `muucmf_module` (
  ...
  `admin_entry` varchar(50) NOT NULL COMMENT '后台入口，0：否 1：是',
...
DROP TABLE IF EXISTS `muucmf_role_config`;
CREATE TABLE IF NOT EXISTS `muucmf_role_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `muucmf_user_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(25) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `pid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `muucmf_user_tag_link`;
CREATE TABLE IF NOT EXISTS `muucmf_user_tag_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
